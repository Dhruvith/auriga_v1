...
export default function HowWeWorkSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 md:py-32 lg:py-40 bg-auriga-charcoal overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div ref={headerRef} className="mb-16 md:mb-20">
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-auriga-ivory font-medium leading-[1.1]">
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div
                ...
                className="relative p-6 md:p-8 border border-auriga-sand/10 hover:border-auriga-brass/30 transition-all duration-500 group"
              >
                <span className="font-serif text-5xl md:text-6xl text-auriga-brass/20 font-medium absolute top-4 right-4">
                  {step.num}
                </span>
                <Icon className="w-6 h-6 text-auriga-brass mb-6" strokeWidth={1.5} />
                <h3 className="font-serif text-xl text-auriga-ivory font-medium mb-3">{step.title}</h3>
                <p className="text-sm text-auriga-ivory/60 leading-relaxed font-sans font-light">{step.desc}</p>
